...
public class EncryptionDES {
    ...
    // 字符串默认键值
    private static String strDefaultKey = "3202BJUT!_E!_CloudDisk!@#";
    ...
    public EncryptionDES(String strKey) throws Exception {
    ...
    public static void main(String[] args) {
        try {
            ...
            EncryptionDES des1 = new EncryptionDES();// 使用默认密钥
            ...
            EncryptionDES des2 = new EncryptionDES(key);// 自定义密钥
